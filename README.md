...
[![GitHub](https://img.shields.io/badge/GitHub-Repository-FFB686?style=for-the-badge&logo=github&logoColor=D9E0EE&labelColor=292324)](https://github.com/FrederickStempfle/Modus)
...
```bash
git clone https://github.com/FrederickStempfle/Modus ~/.config/Modus
cd ~/.config/Modus
./install.sh
```
...
- [Frederick Stempfle](https://github.com/FrederickStempfle/)

## Special Thanks

This project was originally created by [SANKALP](https://github.com/S4NKALP/) and [tr1x_em](https://github.com/tr1xem).

Additional thanks to the following people for their incredible help with code and creative ideas:
